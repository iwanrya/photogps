                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('company.update', $company->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-12 col-sm-2 text-right xs-text-left">{{ __('company.name')}}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_system_owner" {{ $user_auth->is_system_owner ? "checked" : "" }} id="is_system_owner" value="1">
